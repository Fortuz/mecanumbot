...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mecanum_teleop\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mecanum_teleop\hook\ament_prefix_path.bat"
